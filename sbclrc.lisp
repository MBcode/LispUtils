...
;(defun lo () (format t "~&start:~a to-now:~a,hl=~a" (uptime) (date) *histlen*) (ex))
...
(defun bt () (sb-debug:print-backtrace)) ;bt
;;;=easier.cl
;Easier ASDF?
...
;=====
;(ql 'swank) ;for extended bt (backtrace)
(defun clbt  ()  (ql 'swank)  (compile-file "/home/bobak/lsp/bt.lisp" :print t)) 
(defun lbt  ()  (load "/home/bobak/lsp/bt" :print t)) ;instead of:
#+IGNORE
...
(sb-ext:set-sbcl-source-location "/home/bobak/dwn/lang/lsp/lisps/sbcl/sbcl") 
...
(defun tp (package &optional (skip '()))
   (do-symbols (symbol package) 
     (unless (member symbol skip) (trace symbol))))
...
(defun print-red  (a)  (format t "~c[31m ~a ~c[0m~%"  #\ESC a #\ESC))
